...
{
    public class ComandoConsultarAduanaAlmacen : Comando
    {
        ...
        public ComandoConsultarAduanaAlmacen(int idAlmacen)
        {
        ...
        public ComandoConsultarAduanaAlmacen(Entidad aduana)
        {
            Entidad = aduana;
        }
        ...
        public override void Ejecutar()
        {
            try
            {
                _aduanas = _dao.ConsultarAduanaPorAlmacen(_idAlmacen);
            }
